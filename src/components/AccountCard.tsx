...
export function AccountCard(){
  ...
  return <Card><Txt weight="600">Cuenta y copias</Txt>
    ...
    <Button label={user?"Gestionar cuenta y copias":"Entrar o crear cuenta"} variant="secondary" icon="cloud" onPress={()=>router.push({ pathname: "/account", params: { from: "profile" } })}/>
  </Card>;
}
