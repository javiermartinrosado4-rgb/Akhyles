...
export default function Profile() {
  ...
  return <Page>
    ...
    <Modal visible={notificationsOpen} animationType="slide" onRequestClose={() => setNotificationsOpen(false)}>
      ...
      {user && <Card><Row style={{ alignItems: "center" }}><View style={{ flex: 1 }}><Txt weight="600">Felicitaciones por logros</Txt><Txt muted size={12}>Avisa cuando alguien felicite uno de tus logros.</Txt></View><Switch accessibilityLabel="Felicitaciones por logros" value={achievementLikesEnabled} disabled={busy} onValueChange={setAchievementNotifications} trackColor={{ false: colors.border, true: colors.selection }} /></Row></Card>}
