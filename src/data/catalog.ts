...
const entries: Exercise[] = [
  ...
  e("shrug-barbell", "Encogimiento Trapecios con barra", "back", 3.1, "intermediate", "isolation", "free", ["shoulders"]),
  e("shrug-dumbbell", "Encogimiento Trapecios con mancuernas", "back", 3.2, "intermediate", "isolation", "free", ["shoulders"]),
  e(
    "lateral-cable",
  ...
  e(
    ...
    "machine",
    [],
    "Coloca la punta de los pies en el borde de la plataforma y extiende el tobillo sin bloquear las rodillas.",
  ),
